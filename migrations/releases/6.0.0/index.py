...
# # list update files 
backend_update_files = os.listdir(config.get("REPORTS_FILEPATH","folder_config") + "backend/update/")

frontend_update_files = os.listdir(config.get("REPORTS_FILEPATH","folder_config") + "frontend/update/")
...
for file in backend_retire_reports_list:
   backend_retire(file)


# checking if access token is generated or not 
