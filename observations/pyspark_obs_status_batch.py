...
ml_distinctCnt_obs_status_spec = {}
...
ml_distinctCnt_obs_status_spec["spec"]["ioConfig"]["inputSource"]["type"] = str(uploadResponse['cloudStorage'])
ml_distinctCnt_obs_status_spec["spec"]["ioConfig"]["inputSource"]["uris"] = []
ml_distinctCnt_obs_status_spec["spec"]["ioConfig"]["inputSource"]["uris"].append(str(uploadResponse['cloudUri']))

successLogger.debug(
                    ml_distinctCnt_obs_status_spec["spec"]["ioConfig"]["inputSource"]["type"] + "\n" +
                    str(ml_distinctCnt_obs_status_spec["spec"]["ioConfig"]["inputSource"]["uris"]) + "\n" +
                    str(ml_distinctCnt_obs_status_spec)
                  )
